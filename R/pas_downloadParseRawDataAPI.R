...
#' 
#' @title Download synoptic data from PurpleAir API
#' 
#' @param fieldList list of fields to be downloaded
#' @param X-API-Key api key obtained from Purple Air
#' @param baseUrl url for API defaults to "https://api.purpleair.com/v1/sensors"
...
#' 
#' @references \href{https://api.purpleair.com/}{PurpleAir data API}
...
pas_downloadParseRawDataAPI <- function(
  baseUrl = "https://api.purpleair.com/v1/sensors",
  fieldList = c("name", "primary_id_a", "primary_id_b", 
                "primary_key_a", "primary_key_b", "secondary_id_a",
                "secondary_id_b","secondary_key_a", "secondary_key_b",
                "pm2.5", "temperature_a", "humidity_a", "pressure_a", 
                "pm2.5_10minute_a", "pm2.5_30minute_a", "pm2.5_60minute_a",
                "pm2.5_6hour_a", "pm2.5_24hour_a", "pm2.5_1week_a", 
                "temperature_b", "humidity_b", "pressure_b", 
                "pm2.5_10minute_b", "pm2.5_30minute_b", "pm2.5_60minute_b",
                "pm2.5_6hour_b", "pm2.5_24hour_b", "pm2.5_1week_b",
  ...
  r <- httr::GET(webserviceUrl, query = list(fields = paste(fieldList, collapse = ",")), 
                 httr::add_headers(.headers = c(`X-API-Key` = X-API-Key)))
